...
const Delever = () => {
  ...
  return (
    <div className="dev__module"id="deliver" data-aos="fade-up"> 
      <div className="container">
        <div className="deliver__flex__module">
          <div className="left__flex__module">
            <div className="deliver__text__title">
              {" "}
              <h1 className="title__modules__deliver">Delever</h1>
              <span className="delivery__box">
                <img
