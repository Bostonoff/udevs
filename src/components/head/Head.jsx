...
const Head = () => {
  return (
    <div className="bg__head" data-aos="fade-up">
      <div className="container">
        <div className="main__module">
          <div className="hero__module">
            <div className="left__hero__modules">
              <img
                style={{ width: "246px", margin: "0" }}
              ...
              <div className="btn__contact__head">
                <Button type="primary" className="btn__hero__contact">
                  <a href="#contact"> Contact</a>
                </Button>
              </div>
            </div>
          </div>
          <div className="right__hero__modules">
            <img
