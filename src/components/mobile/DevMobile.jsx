...
const DevMobile = () => {
  return (
    <div className="dev__module" id="mobile" data-aos="fade-up">
      <div className="container">
        <h1 className="title__modules__dev">
        ...
        <div className="dev__flex__module">
          <div className="left__flex__module">
            <p className="text__dev__tech">
              In collaboration with startups, we have learned <br /> how to
              create a creative and functional user <br /> interface for mobile
              applications.
            </p>
            <div className="card__module__dev">
              <div className="card__module__dev__tech">
                <img
          ...
          <div className="right__flex__dev__module">
            {/* <div className="module__position__div"> */}
