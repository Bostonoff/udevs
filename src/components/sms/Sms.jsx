...
const Sms = () => {
  ...
  return (
    <div className="dev__module" id="sms" data-aos="fade-up">
      <div className="container">
        <div className="notification__flex__module">
          <div className="left__flex__module">
            <div className="deliver__text__title">
              {" "}
              <h1 className="title__modules__notification">Smsuz.uz</h1>
              <span className="notification__box">
                <img
            ...
            <p className="text__dev__tech">What we did?</p>
