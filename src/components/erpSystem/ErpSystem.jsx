...
const ErpSystem = () => {
  return (
    <div className="team__module" id="erp-system" data-aos="fade-up">
      <div className="container">
        <h1 className="title__modules">ERP systems</h1>
        <div className="erp__flex__module">
          ...
          <div className="right__flex__dev__module">
            ...
            <div className="position__div__erp">
              <img
